...
#include "drivers/fat/ff.h"			/* FatFs configurations and declarations */
#include "drivers/fat/diskio.h"		/* Declarations of low level disk I/O functions */

//~ extern DRESULT disk_read (BYTE Drive, BYTE* Buffer,  DWORD SectorNumber, BYTE SectorCount);
